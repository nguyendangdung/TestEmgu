...
namespace Media.Rtsp.Server.MediaTypes
{
    ...
    /// </remarks>
    /// 
    public class JPEGMedia : RFC2435Media
    {
        private IWebProxy proxy = null;
        private int framesReceived;
        private long bytesReceived;
        private bool useSeparateConnectionGroup = false; // use separate HTTP connection group or use default
        ...
        /// 
        public JPEGMedia(string name, Uri source, bool enableArchive) : base(name, enableArchive, null, false)
        {
            m_Source = source;
        }

        public JPEGMedia(string name, string source, bool enableArchive) : this(name, new Uri(source), enableArchive) { }
