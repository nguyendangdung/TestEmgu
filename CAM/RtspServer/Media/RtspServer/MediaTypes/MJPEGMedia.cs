...
namespace Media.Rtsp.Server.MediaTypes
{
    ...
    public class MJPEGMedia : RFC2435Media
    {
        ...
        /// 
        public MJPEGMedia(string name, Uri source, bool enableArchive) : base(name, enableArchive, null, false)
        {
            m_Source = source;
        }

        public MJPEGMedia(string name, string source, bool enableArchive) : this(name, new Uri(source), enableArchive) { }
