...
namespace Emgu_ObjectTracking
{
    public partial class Form1 : Form
    {
        ...
        private OpticalFlowPyrLK4 _OpticalFlowPyrLK4 = new OpticalFlowPyrLK4();
        private ObjectDetector _ObjectDetector = new ObjectDetector(@"Cars.xml");
        ...
        public Form1()
        {
            ...
            try
            {
                ...
                _capture = new VideoCapture(@"C:\Users\Nguyen Truong Giang\Documents\Visual Studio 2013\Projects\cam_counting\Test\cars.mp4");
        ...
        private void ProcessFrame(object sender, EventArgs arg)
        {
            if (_capture != null && _capture.Ptr != IntPtr.Zero)
            {
                ...
                try
                {
                    ...
                    _OpticalFlowPyrLK4.Tracking(_frameSmall);
